                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DetailsText(detail: "Ram", text: "${_snapshot.data?['ram']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                            DetailsText(detail: "Storage", text: "${_snapshot.data?['storage']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                            DetailsText(detail: "CPU", text: "${_snapshot.data?['cpu']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                            DetailsText(detail: "Rear Camera", text: "${_snapshot.data?['rearCamera']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                            DetailsText(detail: "Front Camera", text: "${_snapshot.data?['frontCamera']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                            DetailsText(detail: "Battery", text: "${_snapshot.data?['battery']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                            DetailsText(detail: "Display", text: "${_snapshot.data?['screen']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                            DetailsText(detail: "Operating System", text: "${_snapshot.data?['os']}"),
                            Divider(color: Colors.black.withOpacity(0.3)),
                          ],
                        ),
                      ),
