...
class MainCarousel {
  MainCarousel({required this.imageUrl});
  final String imageUrl;

  MainCarousel.fromJson(QueryDocumentSnapshot<Map<String, dynamic>> json)
...
class BGPhones {
  ...
  BGPhones({required this.name, required this.image, required this.docId});
